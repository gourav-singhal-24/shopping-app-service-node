...
emailNotifiy.sendEmail = function (mailItem, callback) {
...
emailNotifiy.emailTemplate = function (templateName, mailItem, callback) {
  ...
  fs.readFile(template, 'utf8', function (err, file) {
    if (err) {
      ...
      mailItem.html = html;
      emailNotifiy.sendEmail(mailItem, callback);
    }
  });
}
